<x-layout>
        ...
        <div class="px-6 pb-4 border-b border-gray-200">
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Kelola dan monitor data pengamatan hama dan penyakit tanaman
                    </p>
                </div>
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    @endcan
                    @can('transaction.hpt.export')
                        <button id="btn-export-hpt" data-export="hpt"
                            ...
                            <svg id="icon-export-hpt" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <svg id="spinner-export-hpt" class="w-5 h-5 animate-spin hidden"
                            ...
                            <span id="text-export-hpt">Export</span>
                        </button>
                    @endcan
                </div>
            </div>
        ...
        <div class="px-6 py-5 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
            <div class="flex items-end gap-4 flex-wrap justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        <button type="button"
                            class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-green-500 transition-all duration-200 text-sm font-medium text-gray-700"
                            ...
                            <div class="p-4 space-y-4">
                                <div>
                                    ...
                                    <input type="date" id="start_date" name="start_date"
                                        ...
                                        class="w-full px-3 py-2 rounded-lg border border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 text-sm transition-all duration-200">
                                </div>
                                <div>
                    ...
                    <div id="ajax-data" data-url="{{ route('transaction.hpt.handle') }}">
                        <div class="flex items-center gap-2">
                            ...
                            <input type="text" name="perPage" id="perPage" value="{{ $perPage }}"
                                autocomplete="off"
                                class="w-16 px-3 py-2 border border-gray-300 rounded-lg text-sm text-center focus:ring-2 focus:ring-green-500 focus:border-green-500 shadow-sm transition-all duration-200" />
                        </div>
                    </div>
                    <div class="relative">
                        ...
                        <input type="text" id="search" autocomplete="off" name="search"
                            ...
                            class="w-80 pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="py-12 text-center">
                                    ...
                                    <p class="text-gray-500 text-sm">Belum ada kegiatan pengamatan HPT yang sesuai
            ...
            @else
                <div class="flex items-center justify-between bg-gray-50 px-4 py-3 rounded-lg">
                    <p class="text-sm text-gray-600">
                        Menampilkan <span class="font-semibold text-gray-800">{{ $hpt->count() }}</span> dari
                        <span class="font-semibold text-gray-800">{{ $hpt->total() }}</span> hasil
                    </p>
                </div>
            @endif
        </div>
    ...
    <div id="listModal"
        ...
        <div
            ...
            <!-- Modal Header -->
            <div
                class="flex items-center justify-between p-6 border-b bg-gradient-to-r from-green-50 to-emerald-50 rounded-t-2xl flex-shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-xl font-bold text-gray-900">Detail Data HPT</h2>
                </div>
