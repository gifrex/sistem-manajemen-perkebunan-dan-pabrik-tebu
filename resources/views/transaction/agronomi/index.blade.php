            ...
            <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    @can('transaction.agronomi.export')
                        <button id="btn-export-agronomi" data-export="agronomi"
                            ...
                            <svg id="icon-export-agronomi" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <svg id="spinner-export-agronomi" class="w-5 h-5 animate-spin hidden"
                            ...
                            <span id="text-export-agronomi">Export</span>
                        </button>
                    @endcan
                </div>
            </div>
