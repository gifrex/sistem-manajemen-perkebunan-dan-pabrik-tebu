...
class SuratJalanNonNfcController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'kategori'            => 'required|string|in:PC,RC1,RC2,RC3',
            'umur'                => 'required|integer|min:1|max:12',
            'kodetebang'          => 'required|string|max:15',
            ...
            'nomorkendaraan'      => 'required|string|max:6',
            'nomorpolisi'         => 'required|string|max:11',
            'namasupir'           => 'required|string|max:25',
            'namakontraktor'      => 'required|string|max:25',
            'namasubkontraktor'   => 'required|string|max:25',
            'tanggaltebang'       => 'required|date',
            'tanggalangkut'       => 'required|date',
